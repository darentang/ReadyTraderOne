...
class AutoTrader(BaseAutoTrader):
    ...
    def insert(self, side, volume, price, lifespan=Lifespan.GOOD_FOR_DAY):
        ...
        price = int(np.round(price / 100) * 100)
    ...
    def pricing(self, side):
        ...
        #     return self.etf_orderbook.best_bid(), Lifespan.GOOD_FOR_DAY
        ...
        #     return self.etf_orderbook.best_ask(), Lifespan.GOOD_FOR_DAY
